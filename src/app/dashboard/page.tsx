    ...
    const SidebarContent = (
        <div className="flex flex-col h-full justify-between p-6 bg-gray-800 text-white w-64">
            <div className="space-y-4">
                ...
                <button className="block w-full text-left hover:bg-gray-700 p-2 rounded" onClick={() => { setActivePage("dashboard"); setSidebarOpen(false); }}>
                    Dashboard
                </button>
                <button className="block w-full text-left hover:bg-gray-700 p-2 rounded" onClick={() => { setActivePage("payment"); setSidebarOpen(false); }}>
                    Payment of Fees
                </button>
                <button className="block w-full text-left hover:bg-gray-700 p-2 rounded" onClick={() => { setActivePage("course"); setSidebarOpen(false); }}>
                    Course Registration
                </button>
                <div>
                    <button
                    ...
                    {activePage === "results" && (
                        <div className="ml-4 space-y-1">
                            <button className="block hover:bg-gray-700 p-1 rounded w-full text-left" onClick={() => setSelectedTerm("firstTerm")}>
                                First Term
                            </button>
                            <button className="block hover:bg-gray-700 p-1 rounded w-full text-left" onClick={() => setSelectedTerm("secondTerm")}>
                                Second Term
                            </button>
                            <button className="block hover:bg-gray-700 p-1 rounded w-full text-left" onClick={() => setSelectedTerm("thirdTerm")}>
                                Third Term
                            </button>
                        </div>
                    )}
